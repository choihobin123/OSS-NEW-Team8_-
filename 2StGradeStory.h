...
static const Event events_y2[13] = {
    ...
    {   // 10. 입대 영장 혹은 휴학 (엔딩)
        .question = "2학년이 끝나간다. 집으로 입영통지서가 날아왔다(혹은 휴학 고민).",
        .choice1 = "피할 수 없으면 즐겨라. 휴학하고 군대/휴식을 택한다.",
        .choice2 = "지금 가는 건 아쉽다. 입대를 미루고 3학년을 준비한다.",
        .choice3 = "친구의 입대 소식에 밤새 술을 마셔준다.",
        .stateChange1 = { 0,   0, -1 },   // 군대/휴학 -> 여친 있으면 이별 확률(설정상 -1)
        .stateChange2 = { +10, +5, 0 },   // 계속함에 대한 압박
        .stateChange3 = { +5,  0,  0 },   // 숙취
        .next1 = -1, // 엔딩
        .next2 = -1, // 엔딩
        .next3 = -1  // 엔딩
    },
    ...
    {   // 12. [분기] 횡령 제안
        .question = "선배가 공금을 챙기다 눈이 마주쳤다. 선배가 돈 봉투를 건넨다.",
        .choice1 = "조용히 봉투를 주머니에 넣는다. (공범)",
