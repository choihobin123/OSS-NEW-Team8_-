...
void printEnding(const State* st) {
    ...
    typingPrint(" 4년이라는 긴 시간이 주마등처럼 스쳐 지나갑니다.\n");
    typingPrint(" 벚꽃이 흩날리던 입학식, 밤새워 코딩하던 도서관, 그리고...\n\n");
    Sleep(1500);

    typingPrint(" 단상 위에서 당신의 이름이 호명됩니다.\n");
    typingPrint(" 학사모를 고쳐 쓰며, 당신은 미래를 향해 발걸음을 내딛습니다.\n\n");
    Sleep(1500);
    ...
    if (st->stress < 150 && st->skill > 150) {
        ...
        setColor(15);
        typingPrint(" [대기업 SW 개발자 합격]\n\n");
        typingPrint(" \"축하합니다! 귀하는 당사의 신입 개발자로 채용되었습니다.\"\n");
        typingPrint(" 높은 연봉, 수평적인 문화, 그리고 쾌적한 판교의 오피스.\n");
        typingPrint(" 적절한 워라밸을 지키며 쌓아온 당신의 노력이 빛을 발했습니다.\n");
        typingPrint(" 당신은 동기들의 부러움을 한 몸에 받으며 사회로 나아갑니다.\n");
    }
    // [교수 엔딩] 대학원 진학 (코딩 능력치 초월)
        ...
        setColor(15);
        typingPrint(" [대학원 석박사 통합 과정 진학]\n\n");
        typingPrint(" \"자네, 대학원 올 생각 없나? 랩실에 자리가 하나 남는데...\"\n");
        typingPrint(" 교수님의 은밀한 제안. 당신의 뛰어난 실력을 학계가 놓아주지 않았습니다.\n");
        typingPrint(" 남들은 취업 전선에 뛰어들 때, 당신은 진리의 상아탑에 남기로 합니다.\n");
        typingPrint(" (대학원생 노예 생활이 시작된 것일지도 모릅니다...)\n");
    }
    // [일반 엔딩] 무난한 졸업
    else {
        setColor(7); // 기본색
        ...
        typingPrint(" [평범한 학사 졸업]\n\n");
        typingPrint(" 다사다난했던 대학 생활이 끝났습니다.\n");
        typingPrint(" 엄청난 대기업은 아니지만, 중견 기업에 무난하게 취업했습니다.\n");
        typingPrint(" 가끔은 후회도 되고, 가끔은 뿌듯하기도 했던 4년.\n");
        typingPrint(" 이제 학생이라는 신분을 벗고, 진짜 사회인으로서의 삶을 시작합니다.\n");
    }
    ...
    setColor(15);
    printf("                 [ 최종 스텟 ]\n");
    printf("  코딩 실력 : %3d   |   스트레스 : %3d\n", st->skill, st->stress);
    printf("  여친 여부 : %3d   |   (0이면 여친 없음, 1이면 여친 있음)\n", st->gf);
    setColor(8);
    printf(" --------------------------------------------------\n");
